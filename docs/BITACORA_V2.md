...
- Evaluar, como mejora opcional y de menor prioridad, una prueba de concepto de WhatsApp como segundo canal de entrada, usando el WhatsApp Sandbox de Twilio.
