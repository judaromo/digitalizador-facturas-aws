...
- Punto 2 (campos nuevos: teléfono, dirección, número de factura, comprador) ya implementado (sección 5.37) -- pendiente de que el usuario aplique `migracion_punto2.sql` y despliegue la Lambda y `app.py`, y de la verificación con datos reales, mismo paso que ya se hizo con el punto 1.
